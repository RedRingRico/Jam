#ifndef __JAM_SHADER_HPP__
#define __JAM_SHADER_HPP__
...
namespace Jam
{
	...
	public:
		...
		JAM_UINT32 CreateShaderFromSource( const std::string &p_Source,
		...
		JAM_UINT32 GetShaderParameters(
	...
	private:
		JAM_UINT32 ExtractUniformNames( const GLchar *p_Source );
		JAM_UINT32 BindUniformNamesToLocations( );
